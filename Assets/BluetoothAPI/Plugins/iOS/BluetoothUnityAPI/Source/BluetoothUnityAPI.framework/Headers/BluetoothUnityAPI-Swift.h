...
- (BOOL)ScanNearbyDevicesWithScanningTime:(NSInteger)scanningTime SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)unsubscribe:(BluetoothHelperCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable * _Nullable)error;
